    ...
    return (
        <div>
					...
					<svg className={classes.topStyling} width="100vw" viewBox="0 0 1280 329" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<path fillRule="evenodd" clipRule="evenodd" d="M390.244 223.453C418.83 220.36 447.485 228.205 472.08 243.098C551.02 290.897 665.993 321 794 321C872.346 321 945.81 309.723 1009.12 290.015C1027.45 284.309 1046.89 282.963 1065.79 286.329C1108.31 293.902 1153.77 298 1201 298C1227.98 298 1254.39 296.662 1280 294.103V4H0L0 159.774C78.0143 201.924 185.862 228 305 228C334.183 228 362.688 226.435 390.244 223.453Z" fill="#FFB174"/>
						</g>
						<defs>
						<filter id="filter0_dd" x="-4" y="0" width="1288" height="329" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
